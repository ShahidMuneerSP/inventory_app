...
class FantaAddCard extends StatefulWidget {
  const FantaAddCard({Key? key}) : super(key: key);

  @override
  State<FantaAddCard> createState() => _FantaAddCardState();
}

class _FantaAddCardState extends State<FantaAddCard> {
  @override
