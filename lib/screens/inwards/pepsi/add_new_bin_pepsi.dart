...
import 'package:inventory_app_ui/screens/inwards/pepsi/pepsi_add_card.dart';

import 'package:permission_handler/permission_handler.dart';
import 'package:qrscan/qrscan.dart' as scanner;
import 'package:intl/intl.dart';

class AddNewBinPepsi extends StatefulWidget {
  const AddNewBinPepsi({Key? key}) : super(key: key);

  @override
  State<AddNewBinPepsi> createState() => _AddNewBinPepsiState();
}

class _AddNewBinPepsiState extends State<AddNewBinPepsi> {
