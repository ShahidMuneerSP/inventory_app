...
import 'package:inventory_app_ui/screens/outwards/pepsi/new_delivery_notes_pepsi.dart';
import 'package:inventory_app_ui/screens/outwards/screen_os33.dart';

class AddOutwardPepsi extends StatelessWidget {
  const AddOutwardPepsi({Key? key}) : super(key: key);
        ...
        children: [
          SizedBox(
            ...
            child: ElevatedButton(
                ...
                onPressed: () {
                  Get.to(const NewDeliveryNotesPepsi());
                },
                child: Row(
                  children: [
                    Spacer(),
